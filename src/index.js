...
function parametersEncode(event) {
  ...
  document.getElementById("result-text").innerHTML = cipher.encode(
    nOffset,
    message
  );
}
...
function parametersDecode(event) {
  ...
  document.getElementById("result-text").innerHTML = cipher.decode(
    nOffset,
    message
  );
}
...
document
  .getElementById("btn-cipher")
  .addEventListener("click", parametersEncode);
document
  .getElementById("btn-decipher")
  .addEventListener("click", parametersDecode);
